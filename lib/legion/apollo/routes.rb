...
# its registration with defined?(Routes::Apollo) so double-registration is avoided.
...
module Legion
  module Apollo
    ...
    module Routes
      ...
      def self.register_query_route(app) # rubocop:disable Metrics/MethodLength
      ...
      def self.register_ingest_route(app) # rubocop:disable Metrics/MethodLength,Metrics/AbcSize
      ...
      module ApolloHelpers
        ...
        def apollo_graph_topology # rubocop:disable Metrics/MethodLength,Metrics/AbcSize
        ...
        def apollo_expertise_map # rubocop:disable Metrics/MethodLength,Metrics/AbcSize
          conn = Legion::Data.connection
        ...
        def apollo_stats # rubocop:disable Metrics/AbcSize
